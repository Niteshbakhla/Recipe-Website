...
const Update = () => {
  ...
  return (
    <div className='w-full h-full flex justify-center outline rounded-xl'>
      <form action="" className=' bg-black p-6 text-black flex flex-col items-center bg-[url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5pBfRZ13crt-3-nwUd6HcglcsMSBWSWXiaw&s)] bg-center bg-cover bg-no-repeat  gap-5 rounded-xl w-full' onSubmit={handleSubmit(formSubmitHandler)}>
        <label htmlFor="" className='text-white flex gap-3 items-center font-semibold'>
         ...
         <label htmlFor="" className='text-white flex items-center gap-3 font-semibold'>
          ...
          <label htmlFor="" className='text-white flex items-center gap-3 w-full font-semibold'>
            Title:
            <textarea className='text-black p-3 rounded w-full border border-black' {...register("description")} name="" id="" placeholder='Enter description'></textarea>
          </label>

           <label htmlFor="" className='text-white flex items-center gap-3 w-full font-semibold'>
           Title:
           <textarea className=' w-full text-black p-3 rounded border border-black' {...register("instructions")}name="" id="" placeholder='Enter instructions'></textarea>
           </label>

            <label htmlFor="" className='text-white flex items-center gap-3 w-full font-semibold '>
              Title:
              <textarea className='w-full text-black p-3 rounded border border-black' {...register("ingradients")}name="" id="" placeholder='Enter ingradients'></textarea>
            </label>

            <label htmlFor="" className='w-full text-white flex  items-center gap-3 font-semibold'>
              Catagory:
              <select className='text-black font-[poppins] text-sm bg-gray-300 p-3 rounded w-full' name="" id="" {...register("catagory")}>
